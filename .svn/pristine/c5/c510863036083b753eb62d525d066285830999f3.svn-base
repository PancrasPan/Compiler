...
// DSP Specific e_flags
enum {
	EF_DSP_NOREORDER = 0x00000001, // Don't reorder instructions
	EF_DSP_PIC = 0x00000002, // Position independent code
	EF_DSP_CPIC = 0x00000004, // Call object with Position independent code
	EF_DSP_ARCH_1 = 0x00000000, // DSP1 instruction set
	EF_DSP_ARCH_2 = 0x10000000, // DSP2 instruction set
	EF_DSP_ARCH_3 = 0x20000000, // DSP3 instruction set
	EF_DSP_ARCH_4 = 0x30000000, // DSP4 instruction set
	EF_DSP_ARCH_5 = 0x40000000, // DSP5 instruction set
	EF_DSP_ARCH_32 = 0x50000000, // DSP32 instruction set per linux not elf.h
	EF_DSP_ARCH_64 = 0x60000000, // DSP64 instruction set per linux not elf.h
	EF_DSP_ARCH_32R2 = 0x70000000, // DSP32r2
	EF_DSP_ARCH_64R2 = 0x80000000, // DSP64r2
	EF_DSP_ARCH = 0xf0000000 // Mask for applying EF_DSP_ARCH_ variant
};
...
enum {
	...
	R_DSP_TLS_GD = 42,
	R_DSP_TLS_LDM = 43,
	R_DSP_TLS_DTP_HI16 = 44,
	R_DSP_TLS_DTP_LO16 = 45,
	R_DSP_TLS_GOTTPREL = 46,
	R_DSP_TLS_TPREL32 = 47,
	R_DSP_TLS_TP_HI16 = 49,
	R_DSP_TLS_TP_LO16 = 50,
	R_DSP_GLOB_DAT = 51,
	R_DSP_JUMP_SLOT = 127
};
